...
print("KEY FINDING")
print("=" * 60)
print("  LLM Guard's PromptInjection scanner is a single DeBERTa model")
print("  trained on known injection patterns. It has a learned decision")
print("  boundary that can be found and crossed.")
print("")
print("  Adversarial perturbations that preserve injection intent but")
print("  alter surface form can reduce the detection score below the")
print("  blocking threshold.")
print("")
print("  This does NOT mean LLM Guard is useless — it blocks ~90% of")
print("  known payloads (Module 6 result). It means:")
print("    1. Single-classifier defences have exploitable boundaries")
print("    2. Defence requires multiple layers:")
print("       - Input scanner (LLM Guard) — blocks the vast majority")
print("       - Output scanner — detect if the LLM's response looks")
print("         like it followed an injection (compliant output scanning)")
print("       - Rate limiting on borderline scores (0.3–0.6 range)")
print("       - Ensemble classifiers for borderline cases")
print("")
print("  This is the adversarial ML argument for defence-in-depth:")
print("  any single classifier can be evaded; stacked controls cannot.")
print("=" * 60)
