...
public final class R {
    ...
    public static final class styleable {
        ...
        public static final int[] AlertDialog = {android.R.attr.layout, jakhar.aseem.diva.R.attr.buttonPanelSideLayout, jakhar.aseem.diva.R.attr.listLayout, jakhar.aseem.diva.R.attr.multiChoiceItemLayout, jakhar.aseem.diva.R.attr.singleChoiceItemLayout, jakhar.aseem.diva.R.attr.listItemLayout};
        public static final int[] AppBarLayout = {android.R.attr.background, jakhar.aseem.diva.R.attr.elevation, jakhar.aseem.diva.R.attr.expanded};
        ...
        public static final int[] AppCompatTextView = {android.R.attr.textAppearance, jakhar.aseem.diva.R.attr.textAllCaps};
        ...
        public static final int[] CompoundButton = {android.R.attr.button, jakhar.aseem.diva.R.attr.buttonTint, jakhar.aseem.diva.R.attr.buttonTintMode};
        public static final int[] CoordinatorLayout = {jakhar.aseem.diva.R.attr.keylines, jakhar.aseem.diva.R.attr.statusBarBackground};
        public static final int[] CoordinatorLayout_LayoutParams = {android.R.attr.layout_gravity, jakhar.aseem.diva.R.attr.layout_behavior, jakhar.aseem.diva.R.attr.layout_anchor, jakhar.aseem.diva.R.attr.layout_keyline, jakhar.aseem.diva.R.attr.layout_anchorGravity};
        ...
        public static final int[] FloatingActionButton = {android.R.attr.background, jakhar.aseem.diva.R.attr.elevation, jakhar.aseem.diva.R.attr.rippleColor, jakhar.aseem.diva.R.attr.fabSize, jakhar.aseem.diva.R.attr.pressedTranslationZ, jakhar.aseem.diva.R.attr.borderWidth, jakhar.aseem.diva.R.attr.backgroundTint, jakhar.aseem.diva.R.attr.backgroundTintMode};
        public static final int[] ForegroundLinearLayout = {android.R.attr.foreground, android.R.attr.foregroundGravity, jakhar.aseem.diva.R.attr.foregroundInsidePadding};
        public static final int[] LinearLayoutCompat = {android.R.attr.gravity, android.R.attr.orientation, android.R.attr.baselineAligned, android.R.attr.baselineAlignedChildIndex, android.R.attr.weightSum, jakhar.aseem.diva.R.attr.divider, jakhar.aseem.diva.R.attr.measureWithLargestChild, jakhar.aseem.diva.R.attr.showDividers, jakhar.aseem.diva.R.attr.dividerPadding};
        public static final int[] LinearLayoutCompat_Layout = {android.R.attr.layout_gravity, android.R.attr.layout_width, android.R.attr.layout_height, android.R.attr.layout_weight};
        public static final int[] ListPopupWindow = {android.R.attr.dropDownHorizontalOffset, android.R.attr.dropDownVerticalOffset};
        public static final int[] MenuGroup = {android.R.attr.enabled, android.R.attr.id, android.R.attr.visible, android.R.attr.menuCategory, android.R.attr.orderInCategory, android.R.attr.checkableBehavior};
        public static final int[] MenuItem = {android.R.attr.icon, android.R.attr.enabled, android.R.attr.id, android.R.attr.checked, android.R.attr.visible, android.R.attr.menuCategory, android.R.attr.orderInCategory, android.R.attr.title, android.R.attr.titleCondensed, android.R.attr.alphabeticShortcut, android.R.attr.numericShortcut, android.R.attr.checkable, android.R.attr.onClick, jakhar.aseem.diva.R.attr.showAsAction, jakhar.aseem.diva.R.attr.actionLayout, jakhar.aseem.diva.R.attr.actionViewClass, jakhar.aseem.diva.R.attr.actionProviderClass};
        public static final int[] MenuView = {android.R.attr.windowAnimationStyle, android.R.attr.itemTextAppearance, android.R.attr.horizontalDivider, android.R.attr.verticalDivider, android.R.attr.headerBackground, android.R.attr.itemBackground, android.R.attr.itemIconDisabledAlpha, jakhar.aseem.diva.R.attr.preserveIconSpacing};
        public static final int[] NavigationView = {android.R.attr.background, android.R.attr.fitsSystemWindows, android.R.attr.maxWidth, jakhar.aseem.diva.R.attr.elevation, jakhar.aseem.diva.R.attr.menu, jakhar.aseem.diva.R.attr.itemIconTint, jakhar.aseem.diva.R.attr.itemTextColor, jakhar.aseem.diva.R.attr.itemBackground, jakhar.aseem.diva.R.attr.itemTextAppearance, jakhar.aseem.diva.R.attr.headerLayout};
        public static final int[] PopupWindow = {android.R.attr.popupBackground, jakhar.aseem.diva.R.attr.overlapAnchor};
        ...
        public static final int[] SearchView = {android.R.attr.focusable, android.R.attr.maxWidth, android.R.attr.inputType, android.R.attr.imeOptions, jakhar.aseem.diva.R.attr.layout, jakhar.aseem.diva.R.attr.iconifiedByDefault, jakhar.aseem.diva.R.attr.queryHint, jakhar.aseem.diva.R.attr.defaultQueryHint, jakhar.aseem.diva.R.attr.closeIcon, jakhar.aseem.diva.R.attr.goIcon, jakhar.aseem.diva.R.attr.searchIcon, jakhar.aseem.diva.R.attr.searchHintIcon, jakhar.aseem.diva.R.attr.voiceIcon, jakhar.aseem.diva.R.attr.commitIcon, jakhar.aseem.diva.R.attr.suggestionRowLayout, jakhar.aseem.diva.R.attr.queryBackground, jakhar.aseem.diva.R.attr.submitBackground};
        public static final int[] SnackbarLayout = {android.R.attr.maxWidth, jakhar.aseem.diva.R.attr.elevation, jakhar.aseem.diva.R.attr.maxActionInlineWidth};
        public static final int[] Spinner = {android.R.attr.popupBackground, android.R.attr.prompt, android.R.attr.dropDownWidth, jakhar.aseem.diva.R.attr.popupTheme};
        public static final int[] SwitchCompat = {android.R.attr.textOn, android.R.attr.textOff, android.R.attr.thumb, jakhar.aseem.diva.R.attr.track, jakhar.aseem.diva.R.attr.thumbTextPadding, jakhar.aseem.diva.R.attr.switchTextAppearance, jakhar.aseem.diva.R.attr.switchMinWidth, jakhar.aseem.diva.R.attr.switchPadding, jakhar.aseem.diva.R.attr.splitTrack, jakhar.aseem.diva.R.attr.showText};
